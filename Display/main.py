...
def data_normal(datafr):
    return datafr[datafr["Target_Method"] == "Normal Squares"]


def data_basic(datafr):
    return datafr[datafr["Target_Method"] == "Basic"]


def data_grass(datafr):
    return datafr[datafr["Target_Method"] == "Grass Squares"]

def chooseHeuristic(datafr, str):
    return datafr[datafr['heuristic'] == str]
...
df.replace("OriginalModel", "Basic", inplace=True)
df.replace("OctagonTessellationModel_NormalSquares", "Normal Squares", inplace=True)
df.replace("OctagonTessellationModel_GrassSquares", "Grass Squares", inplace=True)

df10 = df[df["size"] == 10]
df20 = df[df["size"] == 20]
df30 = df[df["size"] == 30]

basicData = data_basic(df)
grassData = data_grass(df)
normalData = data_normal(df)


plt.figure(figsize=(10, 4))
sb.boxplot(data=df10, y="Target_Method", x="Measurement_Value", gap=.1, hue="heuristic", orient='h')
...
plt.figure(figsize=(10, 4))
sb.boxplot(data=df20, y="Target_Method", x="Measurement_Value", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Time in µs')
plt.xlim(0, 10000)
plt.ylabel("")
...
plt.figure(figsize=(10, 4))
sb.boxplot(data=df30, y="Target_Method", x="Measurement_Value", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Time in µs')
plt.xlim(0, 38000)
plt.ylabel("")
...
plt.figure(figsize=(10, 4))
sb.boxplot(data=normalData, y='size', x="Measurement_Value", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Time in µs')
plt.xlim(0, 40000)
...
plt.figure(figsize=(10, 4))
sb.boxplot(data=basicData, y='size', x="Measurement_Value", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Time in µs')
plt.xlim(0, 40000)
...
plt.figure(figsize=(10, 4))
sb.boxplot(data=grassData, y='size', x="Measurement_Value", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Time in µs')
plt.xlim(0, 40000)
plt.ylabel("Length and height of the grid in octagons")
...
plt.figure(figsize=(10, 4))
sb.barplot(data=df10, y="Target_Method", x="AllocatedKB", gap=.1, hue="heuristic", orient='h')
...
plt.figure(figsize=(10, 4))
sb.barplot(data=df20, y="Target_Method", x="AllocatedKB", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Allocated memory in KB')
plt.xlim(0,34000)
plt.ylabel("")
...
plt.figure(figsize=(10, 4))
sb.barplot(data=df30, y="Target_Method", x="AllocatedKB", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Allocated memory in KB')
plt.xlim(0,34000)
plt.ylabel("")
...
plt.figure(figsize=(10, 4))
sb.barplot(data=normalData, y='size', x="AllocatedKB", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Allocated memory in KB')
plt.xlim(0,34000)
plt.ylabel("Length and height of the grid in octagons")
...
plt.figure(figsize=(10, 4))
sb.barplot(data=basicData, y='size', x="AllocatedKB", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Allocated memory in KB')
plt.xlim(0,34000)
plt.ylabel("Length and height of the grid in squares")
...
plt.figure(figsize=(10, 4))
sb.barplot(data=grassData, y='size', x="AllocatedKB", gap=.1, hue="heuristic", orient='h')
plt.xlabel('Allocated memory in KB')
plt.xlim(0,34000)
plt.ylabel("Length and height of the grid in octagons")
